  ...
  return knex('workouts').del()
    .then(() => {
      ...
      return knex('workouts').insert([
        { id: 1, client_id: 1, trainer_id: 1, date: '03/10/18', name: 'Power Hour', created_by_trainer: true },
        ...
        { id: 6, client_id: 1, trainer_id: 1, date: '03/15/18', name: 'Power Hour', created_by_trainer: true },
        { id: 7, client_id: 1, trainer_id: 1, date: '03/13/18', name: 'Power Hour', created_by_trainer: true },
      ])
    }).then(() => {
      return knex.raw(
